...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final name  = auth.userName ?? 'John Anderson';
    final total = bp.bookings.length;
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        // ── Light lavender background (replaces teal-tinted grey) ──
        backgroundColor: AppColors.background, // #F8F7FF
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Stack(
                    children: [
                      // Glow blobs — white, same as before (look fine on purple)
                      Positioned(
                        top: -40, right: -40,
                    ...
                    child: ClipRRect(
                      ...
                      child: BackdropFilter(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              _statItem('$total', 'BOOKINGS'),
                              Container(
                                  width: 1, height: 32,
                                  color: AppColors.cardBorder),
                              _statItem('12', 'FAVORITES'),
                              Container(
                                  width: 1, height: 32,
                                  color: AppColors.cardBorder),
